...
const Slider = ({
  ...
  return (
    <div className="relative ">
      {isLeftButton && (
        <button
          className={`absolute top-32 -left-2 z-20 p-2 bg-white hover:bg-zinc-100 rounded-full shadow-normal duration-300 `}
          onClick={handlePrev}
        >
      ...
      <button
        className="absolute top-32 -right-2 z-20 p-2 bg-white hover:bg-zinc-100  rounded-full  shadow-normal duration-300"
        onClick={handleNext}
      >
